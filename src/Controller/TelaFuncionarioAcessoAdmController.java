 ...
 * @author Usuário
 */
public class TelaFuncionarioAcessoAdmController implements Initializable {
    ...
    @FXML
    public void funcoesAdm() throws Exception {
        Stage stage = (Stage) btLogout.getScene().getWindow();
        stage.close();
        TelaAdministradorView telaAdm = new TelaAdministradorView();
